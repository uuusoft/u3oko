...
{
class CConvMod5x5Alg final : public IOptimAlg
{
  public:
  static constexpr const char* val_key = "libs.optim.s16bit.conv.base.c5x5.mod";
  ...
  virtual ~CConvMod5x5Alg () = default;
  ...
  sync_impl_int (const ::libs::optim::io::TInit& iinfo) override
  {
    ...
    case ::libs::utility::sys::cpu::CpuExts::avx2:
      sel_.set (::libs::optim::s16bit::conv::base::c5x5::mod_avx2);
      break;
    case ::libs::utility::sys::cpu::CpuExts::avx1:
      sel_.set (::libs::optim::s16bit::conv::base::c5x5::mod_avx1);
      break;
    ...
    case ::libs::utility::sys::cpu::CpuExts::sse2:
      sel_.set (::libs::optim::s16bit::conv::base::c5x5::mod_sse2);
      break;
#endif
#ifdef U3_CPU_ARM
    case ::libs::utility::sys::cpu::CpuExts::neon:
      sel_.set (::libs::optim::s16bit::conv::base::c5x5::mod_neon);
      break;
#endif
