...
{
class CSetConstAlg final : public IOptimAlg
{
  public:
  static constexpr const char* val_key = "libs.optim.s16bit.bits.consts.set_const";
  ...
  sync_impl_int (const ::libs::optim::io::TInit& iinfo) override
  {
    ...
    case ::libs::helpers::sys::cpu::CpuExts::avx2:
      sel_.set (::libs::optim::s16bit::bits::one_source::set::avx2);
      break;
    case ::libs::helpers::sys::cpu::CpuExts::avx1:
      sel_.set (::libs::optim::s16bit::bits::one_source::set::avx1);
      break;
    ...
    case ::libs::helpers::sys::cpu::CpuExts::sse2:
      sel_.set (::libs::optim::s16bit::bits::one_source::set::sse2);
      sel_.set (::libs::optim::s16bit::bits::one_source::set::alu);
      break;
