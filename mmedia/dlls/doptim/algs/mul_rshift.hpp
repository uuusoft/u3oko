...
{
class CMulRShiftAlg final : public IOptimAlg
{
  public:
  static constexpr const char* val_key = "libs.optim.s16bit.ops.mul_rshift";
  ...
  sync_impl_int (const ::libs::optim::io::TInit& iinfo) override
  {
    ...
    case ::libs::helpers::sys::cpu::CpuExts::avx2:
      sel_.set (::libs::optim::s16bit::ops::mul_rshift_avx2);
      break;
    case ::libs::helpers::sys::cpu::CpuExts::avx1:
      sel_.set (::libs::optim::s16bit::ops::mul_rshift_avx1);
      break;
    ...
    case ::libs::helpers::sys::cpu::CpuExts::sse2:
      sel_.set (::libs::optim::s16bit::ops::mul_rshift_sse2);
      sel_.set (::libs::optim::s16bit::ops::mul_rshift_alu);
      break;
#endif
