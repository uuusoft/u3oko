...
{
class CFreqDCT8x8BackwardAlg final : public IOptimAlg
{
  public:
  static constexpr const char* val_key = "libs.optim.s16bit.freq.dct.b8x8.backward";

  CFreqDCT8x8BackwardAlg ()
  {
    sync_impl (::libs::optim::io::TInit ());
    sel_.set_algoritm_name (val_key);
  }

  virtual ~CFreqDCT8x8BackwardAlg () = default;
  ...
  sync_impl_int (const ::libs::optim::io::TInit& iinfo) override
  {
    ...
    case ::libs::helpers::sys::cpu::CpuExts::avx2:
      sel_.set (::libs::optim::s16bit::freq::dct::b8x8::backward::avx2);
      break;
    case ::libs::helpers::sys::cpu::CpuExts::avx1:
      sel_.set (::libs::optim::s16bit::freq::dct::b8x8::backward::avx1);
      break;
    ...
    case ::libs::helpers::sys::cpu::CpuExts::sse2:
      sel_.set (::libs::optim::s16bit::freq::dct::b8x8::backward::sse2);
      sel_.set (::libs::optim::s16bit::freq::dct::b8x8::backward::alu);
      break;
#endif
