...
{
class CYUY22RgbAlg final : public IOptimAlg
{
  public:
  static constexpr const char* val_key = "libs.optim.convert.yuy2_rgb24";
  ...
  sync_impl_int (const ::libs::optim::io::TInit& iinfo) override
  {
    ...
    case ::libs::utility::sys::cpu::CpuExts::avx2:
      sel_.set (::libs::optim::convert::yuy2_rgb24::alu);
      break;
    ...
    case ::libs::utility::sys::cpu::CpuExts::usual:
      ...
      sel_.set (::libs::optim::convert::yuy2_rgb24::alu);
      // EAI-REFACT swap U V component
      // sel_.set (::libs::optim::convert::yuy2_rgb24::neon);
#else
      sel_.set (::libs::optim::convert::yuy2_rgb24::alu);
#endif
      break;
