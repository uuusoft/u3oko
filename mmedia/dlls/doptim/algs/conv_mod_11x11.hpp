...
{
class CConvMod11x11Alg final : public IOptimAlg
{
  public:
  static constexpr const char* val_key = "libs.optim.s16bit.conv.base.c11x11.mod";
  ...
  virtual ~CConvMod11x11Alg () = default;
  ...
  sync_impl_int (const ::libs::optim::io::TInit& iinfo) override
  {
    ...
    case ::libs::helpers::sys::cpu::CpuExts::avx2:
      sel_.set (::libs::optim::s16bit::conv::base::c11x11::mod_avx2);
      break;
    case ::libs::helpers::sys::cpu::CpuExts::avx1:
      sel_.set (::libs::optim::s16bit::conv::base::c11x11::mod_avx1);
      break;
    ...
    case ::libs::helpers::sys::cpu::CpuExts::sse2:
      sel_.set (::libs::optim::s16bit::conv::base::c11x11::mod_sse2);
      break;
#endif
    ...
    case ::libs::helpers::sys::cpu::CpuExts::usual:
      ...
      sel_.set (::libs::optim::s16bit::conv::base::c11x11::mod_neon);
#else
      sel_.set (::libs::optim::s16bit::conv::base::c11x11::mod_alu);
#endif
      break;
