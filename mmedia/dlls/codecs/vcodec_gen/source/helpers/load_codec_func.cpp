...
#  ifdef U3_OS_ANDROID
  ...
  info.create_codec_ = ::libs::utility::casts::reinterpret_cast_helper< funcs::get_codec_func_type* > (
    dlsym (native, make_name_function (file_name, consts::func_name_create_codec).c_str ()));

  info.free_codec_ = ::libs::utility::casts::reinterpret_cast_helper< funcs::free_codec_func_type* > (
    dlsym (native, make_name_function (file_name, consts::func_name_delete_codec).c_str ()));

  info.get_codec_info_ = ::libs::utility::casts::reinterpret_cast_helper< funcs::get_codec_info_func_type* > (
