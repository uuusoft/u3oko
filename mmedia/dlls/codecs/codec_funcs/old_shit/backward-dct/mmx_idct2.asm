...
%define INP_0	eax+0
%define INP_1	eax+1* 16
%define INP_2	eax+2* 16
%define INP_3	eax+3* 16
%define INP_4	eax+4* 16
%define INP_5	eax+5* 16
%define INP_6	eax+6* 16
%define INP_7	eax+7* 16

%define OUTP_0	eax+0
%define OUTP_1	eax+1* 16
%define OUTP_2	eax+2* 16
%define OUTP_3	eax+3* 16
%define OUTP_4	eax+4* 16
%define OUTP_5	eax+5* 16
%define OUTP_6	eax+6* 16
%define OUTP_7	eax+7* 16
...
;********************************************************
; code for Pentium III,SSE or XMM
;********************************************************
...
;{
; std::int16_t t0, t1, t2, t3, t4, t5, t6, t7;
; std::int16_t tp03, tm03, tp12, tm12, tp65, tm65;
; std::int16_t tp465, tm465, tp765, tm765;
;
...
_idct8x8_mmx
        ...
        DCT_8_INV_ROW_1 INP_0, OUTP_0, tab_i_04, rounder_0
        DCT_8_INV_ROW_1 INP_1, OUTP_1, tab_i_17, rounder_1
        DCT_8_INV_ROW_1 INP_2, OUTP_2, tab_i_26, rounder_2
        DCT_8_INV_ROW_1 INP_3, OUTP_3, tab_i_35, rounder_3
        DCT_8_INV_ROW_1 INP_4, OUTP_4, tab_i_04, rounder_4
        DCT_8_INV_ROW_1 INP_5, OUTP_5, tab_i_35, rounder_5
        DCT_8_INV_ROW_1 INP_6, OUTP_6, tab_i_26, rounder_6
        DCT_8_INV_ROW_1 INP_7, OUTP_7, tab_i_17, rounder_7
...
_idct8x8_sse
        ...
        DCT_8_INV_ROW_1_sse INP_0, OUTP_0, tab_i_04_sse, rounder_0
        DCT_8_INV_ROW_1_sse INP_1, OUTP_1, tab_i_17_sse, rounder_1
        DCT_8_INV_ROW_1_sse INP_2, OUTP_2, tab_i_26_sse, rounder_2
        DCT_8_INV_ROW_1_sse INP_3, OUTP_3, tab_i_35_sse, rounder_3
        DCT_8_INV_ROW_1_sse INP_4, OUTP_4, tab_i_04_sse, rounder_4
        DCT_8_INV_ROW_1_sse INP_5, OUTP_5, tab_i_35_sse, rounder_5
        DCT_8_INV_ROW_1_sse INP_6, OUTP_6, tab_i_26_sse, rounder_6
        DCT_8_INV_ROW_1_sse INP_7, OUTP_7, tab_i_17_sse, rounder_7
