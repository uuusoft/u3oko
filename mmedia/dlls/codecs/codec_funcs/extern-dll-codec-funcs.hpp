#pragma once
/**
\file       extern-dll-codec-funcs.hpp
\date       28.02.2025
...
#  define U3_CODEC_GET_INFO_FUNCT_EXTERN(name, info)                                                        \
    extern "C" BOOST_SYMBOL_EXPORT void get_codec_info_##name (libs::helpers::uids::minor::id_val guids[4]) \
    {                                                                                                       \
      constexpr std::array< libs::helpers::uids::minor::id_val, 4 > temp = info;                            \
