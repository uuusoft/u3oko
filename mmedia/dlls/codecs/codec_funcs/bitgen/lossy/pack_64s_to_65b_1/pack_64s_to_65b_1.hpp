#pragma once
/**
\file       pack_64s_to_65b_1.hpp
\author     Erashov Anton erashov2026@proton.me
\date       01.01.2017
\project    u3_codec_funcs
*/

namespace dlls::codecs::bitgen::lossy::pack_64s_to_65b_1::consts
{
const std::string   id_string             = "pack_64s_to_65b_1";
const std::uint32_t src_short_granularity = 64;
const std::uint32_t src_granularity       = sizeof (std::int16_t) * src_short_granularity;
const std::uint32_t dst_granularity       = sizeof (std::uint8_t) * 65;
}   // namespace dlls::codecs::bitgen::lossy::pack_64s_to_65b_1::consts
