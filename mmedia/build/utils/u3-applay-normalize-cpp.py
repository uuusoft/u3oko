...
import os
import subprocess
# Напиши на питоне функцию, которая принимает в качестве аргумента путь к файлам с маской. Для всех файлов по маске в переданном путе, вызови clang-format.
# Напиши на питоне функцию, которая принимает в качестве аргумента путь к файлам. Для каждого файла из переданного пути, вызови clang-format, передавая в качестве аргумента путь к файлу.
# Напиши на питоне функцию, которая принимает в качестве аргумента начальный путь к файлам. Для каждого файла рекурсивно, вызови clang-format, передавая в качестве аргумента путь к файлу.
