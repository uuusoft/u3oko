...
add_executable(${U3_TESTS_NAME} /home/erashov/Documents/u3medias/mmedia/libs/utility/mem/ut/ut-libs-helpers-mem.cxx)
...
target_include_directories(${U3_TESTS_NAME} SYSTEM PRIVATE "${U3_INCLUDE_DIR_EXTLIB_GOOGLETEST}")
#message(FATAL_ERROR "U3_LIBS_3RD_STATIC_LIST=${U3_LIBS_3RD_STATIC_LIST}")
#message(FATAL_ERROR "U3_INCLUDE_DIR_EXTLIB_GOOGLETEST=${U3_INCLUDE_DIR_EXTLIB_GOOGLETEST}")
