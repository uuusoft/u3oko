...
u3_project_add(
  PROJECT_NAME
  ${U3_NAME_EXTERNAL_LIB_OPENH264_UTIL}
  PROJECT_VERSION
  "${U3_VERSION_EXTERNAL_LIB_OPENH264}"
  URL_TO_BIN
  ${U3_URL_TO_EXTERNAL_LIB_OPENH264_BIN}
  NAME_BIN_MD5
  U3_EXTERNAL_LIB_OPENH264${U3_VERSION_EXTERNAL_LIB_OPENH264_CID}_MD5_${U3_ENV_GEN_POSTFIX_VARIABLE_NAME_TO_EXT_LIB}
  BIN_MD5
  ${U3_EXTERNAL_LIB_OPENH264${U3_VERSION_EXTERNAL_LIB_OPENH264_CID}_MD5_${U3_ENV_GEN_POSTFIX_VARIABLE_NAME_TO_EXT_LIB}}
  URL_TO_SRC
  ${U3_URL_TO_EXTERNAL_LIB_OPENH264_SRC}
  SRC_MD5
  ${U3_EXTERNAL_LIB_OPENH264_MD5}
  URL_TO_SRC_EXT
  ${U3_URL_TO_EXTERNAL_LIB_OPENH264_SRC_EXT}
  SRC_EXT_MD5
  ${U3_EXTERNAL_LIB_OPENH264_MD5}
...
ExternalProject_Get_Property(${U3_NAME_EXTERNAL_LIB_OPENH264_UTIL} install_dir)

if(${U3_GVXX_PROJECT_ADD_SOURCE_TYPE} STREQUAL "U3_ADD_PROJECT_RESULT_BIN")
  set(U3_INCLUDE_DIR_EXTERNAL_LIB_OPENH264 ${install_dir}/src/openh264-util)
  if(${U3_SYSTEM_NAME} STREQUAL ${U3_SYSTEM_NAME_WINDOWS})
    set(U3_INSTALL_DIR_EXTERNAL_LIB_OPENH264 "${install_dir}/src/openh264-util/openh264.lib")
  else()
  ...
  elseif(${U3_SYSTEM_NAME} STREQUAL ${U3_SYSTEM_NAME_RASPBERRY} OR ${U3_SYSTEM_NAME} STREQUAL ${U3_SYSTEM_NAME_ORANGE_PI})
    ...
    add_custom_command(
      TARGET ${U3_NAME_EXTERNAL_LIB_OPENH264_UTIL}
      POST_BUILD
...
u3_make_fake_file(FILE_NAME ${U3_INSTALL_DIR_EXTERNAL_LIB_OPENH264} CONTENT "openh264")

add_library(openh264-lib STATIC IMPORTED)
add_dependencies(openh264-lib ${U3_NAME_EXTERNAL_LIB_OPENH264_UTIL})
set_target_properties(openh264-lib PROPERTIES IMPORTED_LOCATION ${U3_INSTALL_DIR_EXTERNAL_LIB_OPENH264})

#set( U3_LIBS_3RD_STATIC_LIST ${U3_LIBS_3RD_STATIC_LIST} openh264-lib )
set(U3_DEPENDENCY_TARGETS_LIST ${U3_DEPENDENCY_TARGETS_LIST} ${U3_NAME_EXTERNAL_LIB_OPENH264_UTIL})
