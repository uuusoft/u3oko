...
set(U3_NAME_EXTERNAL_LIB_BOOST_UTIL ${U3_NAME_EXTERNAL_LIB_BOOST}-util)

#message(FATAL_ERROR "NAME=U3_EXTERNAL_LIB_BOOST${U3_VERSION_EXTERNAL_LIB_BOOST_CID}_MD5_${U3_ENV_GEN_POSTFIX_VARIABLE_NAME_TO_EXT_LIB}")
#message(FATAL_ERROR "BIN_MD5=${U3_EXTERNAL_LIB_BOOST${U3_VERSION_EXTERNAL_LIB_BOOST_CID}_MD5_${U3_ENV_GEN_POSTFIX_VARIABLE_NAME_TO_EXT_LIB}}")
u3_project_add(
  PROJECT_NAME
  ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL}
  PROJECT_VERSION
  "v${U3_VERSION_EXTERNAL_LIB_BOOST}"
  URL_TO_BIN
  ${U3_URL_TO_EXTERNAL_LIB_BOOST_BIN}
  NAME_BIN_MD5
  U3_EXTERNAL_LIB_BOOST${U3_VERSION_EXTERNAL_LIB_BOOST_CID}_MD5_${U3_ENV_GEN_POSTFIX_VARIABLE_NAME_TO_EXT_LIB}
  BIN_MD5
  ${U3_EXTERNAL_LIB_BOOST${U3_VERSION_EXTERNAL_LIB_BOOST_CID}_MD5_${U3_ENV_GEN_POSTFIX_VARIABLE_NAME_TO_EXT_LIB}}
  URL_TO_SRC
  ${U3_URL_TO_EXTERNAL_LIB_BOOST_SRC}
  SRC_MD5
  ${U3_EXTERNAL_LIB_BOOST_MD5}
  URL_TO_SRC_EXT
  ${U3_URL_TO_EXTERNAL_LIB_BOOST_SRC_EXT}
  SRC_EXT_MD5
  ${U3_EXTERNAL_LIB_BOOST_MD5}
...
ExternalProject_Get_Property(${U3_NAME_EXTERNAL_LIB_BOOST_UTIL} install_dir)

if(${U3_GVXX_PROJECT_ADD_SOURCE_TYPE} STREQUAL "U3_ADD_PROJECT_RESULT_BIN")
  set(U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST ${install_dir}/src/boost-util)
  set(BOOST_LIBRARYDIR "${U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST}/lib")

  #set(U3_WORK_DIR_EXTERNAL_LIB_BOOST "${install_dir}/src/u3-boost-build")
  #set(U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST "${U3_WORK_DIR_EXTERNAL_LIB_BOOST}/include")
  #set(BOOST_LIBRARYDIR "${U3_WORK_DIR_EXTERNAL_LIB_BOOST}/lib")
  #set(U3_BOOST_SELECTED_LIBS --with-program_options --with-serialization --with-filesystem --with-json --with-thread)
  #set(Boost_ROOT ${U3_WORK_DIR_EXTERNAL_LIB_BOOST})
  set(Boost_ROOT ${U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST})
  #message(FATAL_ERROR "Boost_ROOT=${Boost_ROOT}")
  ...
  if(${U3_SYSTEM_NAME} STREQUAL ${U3_SYSTEM_NAME_LINUX} OR ${U3_SYSTEM_NAME} STREQUAL ${U3_SYSTEM_NAME_RASPBERRY} OR ${U3_SYSTEM_NAME} STREQUAL ${U3_SYSTEM_NAME_ORANGE_PI})
    ...
    add_custom_command(
      TARGET ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL}
      POST_BUILD
      COMMAND cd ${install_dir}/src/boost-util && ./bootstrap.sh --prefix=${U3_WORK_DIR_EXTERNAL_LIB_BOOST} && ./b2 ${U3_BOOST_SELECTED_LIBS} cxxflags=-fPIC cflags=-fPIC && ./b2 install
      VERBATIM
    )
  ...
  elseif(${U3_SYSTEM_NAME} STREQUAL ${U3_SYSTEM_NAME_ANDROID})
    ...
    add_dependencies(${U3_NAME_EXTERNAL_LIB_BOOST_UTIL} ${U3_NAME_EXTERNAL_LIB_BOOST_FOR_ANDROID_UTIL})
    
    #set(U3_WORK_DIR_EXTERNAL_LIB_BOOST ${install_dir}/src/boost-util)
    #set(U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST ${install_dir}/src/boost-util/u3-boost-build/include)
    #set(BOOST_LIBRARYDIR "${U3_WORK_DIR_EXTERNAL_LIB_BOOST}/lib")
    set(U3_WORK_DIR_EXTERNAL_LIB_BOOST "${install_dir}/src/u3-boost-build")
    set(U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST "${U3_WORK_DIR_EXTERNAL_LIB_BOOST}/include")
    set(BOOST_LIBRARYDIR "${U3_WORK_DIR_EXTERNAL_LIB_BOOST}/lib")
    ...
    add_custom_command(
      TARGET ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL}
      POST_BUILD
      COMMAND cd ${U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST_FOR_ANDROID} && ./build-android.sh ${ANDROID_NDK}
      COMMAND ${CMAKE_COMMAND} -E copy_directory <SOURCE_DIR>/build/out/arm64-v8a/lib ${BOOST_LIBRARYDIR}
      COMMAND ${CMAKE_COMMAND} -E copy_directory <SOURCE_DIR>/build/out/arm64-v8a/include/boost-1_91 ${U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST}
      VERBATIM
    )
...
#  )
    ...
    #COMMAND cd ${U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST_FOR_ANDROID} && ./build-android.sh --prefix=${U3_WORK_DIR_EXTERNAL_LIB_BOOST}
    #COMMAND cd ${install_dir}/src/boost-util && ./bootstrap.sh --prefix=${U3_WORK_DIR_EXTERNAL_LIB_BOOST} && ./b2 ${U3_BOOST_SELECTED_LIBS} cxxflags=-fPIC cflags=-fPIC && ./b2 install
    ...
    add_dependencies(boost-program_options-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
    ...
    add_dependencies(boost-filesystem-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
    ...
    add_dependencies(boost-serialization-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
    ...
    add_dependencies(boost-wserialization-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
    ...
    #add_dependencies(boost-threads-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
    ...
    add_dependencies(boost-json-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
    ...
    #add_dependencies(boost-log-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
    #set_target_properties(boost-log-lib PROPERTIES IMPORTED_LOCATION ${BOOST_LIBRARYDIR}/)

    #add_library( STATIC IMPORTED)
    #add_dependencies( ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
...
if(1)
  ...
  add_dependencies(boost-atomic-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
  ...
  add_dependencies(boost-program-options-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
  ...
  add_dependencies(boost-ser-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
  ...
  add_dependencies(boost-wser-lib ${U3_NAME_EXTERNAL_LIB_BOOST_UTIL})
...
include_directories(${U3_INCLUDE_DIR_EXTERNAL_LIB_BOOST})
