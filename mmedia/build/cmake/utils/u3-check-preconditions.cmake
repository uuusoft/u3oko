...
if(NOT ${CMAKE_BUILD_TYPE} IN_LIST U3_INTERNAL_BUILD_LIST)
  message(FATAL_ERROR "${U3_MARK_FATAL}Unknown build type CMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} not in list U3_INTERNAL_BUILD_LIST=${U3_INTERNAL_BUILD_LIST}")
endif()
...
if(NOT ${U3_SANITY_BUILD_TYPE} STREQUAL "none")
  if(NOT (${CMAKE_CXX_COMPILER_ID} STREQUAL "GNU" OR ${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang"))
    message(FATAL_ERROR "${U3_MARK_FATAL}U3_SANITY_BUILD_TYPE=${U3_SANITY_BUILD_TYPE} not supported for CMAKE_CXX_COMPILER_ID=${CMAKE_CXX_COMPILER_ID}")
  endif()
endif()
...
if(NOT ${U3_SYSTEM_NAME} IN_LIST U3_INTERNAL_OS_LIST)
  message(FATAL_ERROR "${U3_MARK_FATAL}Unknown os type U3_SYSTEM_NAME=${U3_SYSTEM_NAME} not in list U3_INTERNAL_OS_LIST=${U3_INTERNAL_OS_LIST}")
endif()
