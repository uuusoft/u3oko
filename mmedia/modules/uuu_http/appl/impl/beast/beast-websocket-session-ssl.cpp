...
{
  U3_XLOG_DEV ("websocket_session_ssl::on_create" + VTOLOG (U3_CAST_PTR2INT (this)));
}


websocket_session_ssl::~websocket_session_ssl ()
{
  U3_XLOG_DEV ("websocket_session_ssl::o_destroy" + VTOLOG (U3_CAST_PTR2INT (this)));
...
{
  U3_XLOG_DEV ("websocket_session_ssl::on_accept" + VTOLOG (U3_CAST_PTR2INT (this)));
  if (ec)
  {
