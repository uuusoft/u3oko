...
{
  U3_XLOG_DEV ("websocket_session::on_create" + VTOLOG (U3_CAST_PTR2INT (this)));
}


websocket_session::~websocket_session ()
{
  U3_XLOG_DEV ("websocket_session::o_destroy" + VTOLOG (U3_CAST_PTR2INT (this)));
...
{
  U3_XLOG_DEV ("websocket_session::on_accept" + VTOLOG (U3_CAST_PTR2INT (this)));
  if (ec)
  {
