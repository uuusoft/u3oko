...
struct hash< ::modules::uuu_storage::appl::impl::indexer::test::StateObject > {
  size_t
  operator() (const ::modules::uuu_storage::appl::impl::indexer::test::StateObject& val) const noexcept
  {
    return hash< typename ::modules::uuu_storage::appl::impl::indexer::test::StateObject::TypeObjectId > () (val.id_);
  }
};
}   // namespace std
