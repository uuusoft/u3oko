/**
\file       sqlite-indexer-impl-int-funcs.cpp
...
namespace modules::uuu_storage::appl::impl::indexer::sqlite::details
{
inline std::string
get_name_state_file ()
{
  return "state_indexer_sqlite_impl.bin";
}
}   // namespace modules::uuu_storage::appl::impl::indexer::sqlite::details
...
SqliteIndexerImpl::update_path ()
{
  ...
  root_path_ = ::libs::helpers::files::make_path (path, std::string ("sqlite-indexer"));
...
SqliteIndexerImpl::save_state ()
{
  ...
  if (!file.is_open ())
  {
    U3_XLOG_ERROR ("open file for save state" + TOLOG (full_path));
    return;
  }
...
void
SqliteIndexerImpl::open_stream (::libs::istorage_events::events::UpdateStream::raw_ptr info)
{
...
void
SqliteIndexerImpl::close_stream (::libs::istorage_events::events::UpdateStream::raw_ptr info)
{
  U3_ASSERT (info->stream_id_ != ::libs::istorage_events::consts::empty_stream_id);
}
}   // namespace modules::uuu_storage::appl::impl::indexer::sqlite
