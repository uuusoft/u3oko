...
{
  return ::libs::utility::casts::reinterpret_cast_helper< TypeAs > (buf->get_buf ());
}
...
{
  return ::libs::utility::casts::reinterpret_cast_helper< const TypeAs > (buf->get_cbuf ());
}
...
get_data_as (IVideoBuf::raw_ptr buf)
{
  ...
  return ::libs::utility::casts::reinterpret_cast_helper< TypeAs > (buf->get_buf () + (*buf)[MemVars::offset_data]);
}
...
{
  U3_CHECK (!buf->get_flag (BufFlags::null), "try get data from null buf");
  return ::libs::utility::casts::reinterpret_cast_helper< const TypeAs > (buf->get_cbuf () + (*buf)[MemVars::offset_data]);
}
...
{
  U3_CHECK (!buf->get_flag (BufFlags::null), "try get data from null buf");
  return ::libs::utility::casts::reinterpret_cast_helper< TypeAs > (buf->get_buf () + (*buf)[MemVars::offset_data] + off);
}
...
{
  return ::libs::utility::casts::reinterpret_cast_helper< const TypeAs > (get_const_buf_as< const std::uint8_t* > (buf) + (*buf)[MemVars::offset_data] + off);
}
