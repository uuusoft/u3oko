...
{
  U3_CHECK_COPY_EVENT (MemResourceHttpEvent);
  super::copy_int (src);
...
void
MemResourceHttpEvent::serialize (Archive& ar, const std::uint32_t /* file_version */)
{
  ar& U3_BOOST_SERIALIZATION_BASE_OBJECT_NVP ("olibsoihttp_eventsoeventsoBaseHttpEvent", super);
