...
class MouseButtonDownEvent : public BaseGUIEvent
{
  ...
  public:
  //  ext types
  U3_HELPER_THIS_TYPE_HAS_POINTERS_TO_SELF (MouseButtonDownEvent)
  U3_HELPER_ADD_MAKE_SHARED_FUNCT2THIS_TYPE (MouseButtonDownEvent)
  U3_HELPER_DISABLE_ACOPY_TYPE (MouseButtonDownEvent)
  ...
  gen_get_mid ()
  {
    static const IEvent::hid_type ret = "libs/igui_events/events/props/mouse-button-down-event";
    return ret;
  }
