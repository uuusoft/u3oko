...
class MemBlockEvent : public BaseGUIEvent
{
  ...
  public:
  //  ext types
  U3_HELPER_THIS_TYPE_HAS_POINTERS_TO_SELF (MemBlockEvent)
  U3_HELPER_ADD_MAKE_SHARED_FUNCT2THIS_TYPE (MemBlockEvent)
  U3_HELPER_DISABLE_ACOPY_TYPE (MemBlockEvent)
  ...
  gen_get_mid ()
  {
    static const IEvent::hid_type ret = "libs/igui_events/events/props/mem-block-event";
    return ret;
  }
