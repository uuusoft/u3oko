...
{
MouseButtonUpEvent::MouseButtonUpEvent (const Acessor& ph, const TypeMouseButton& type, const utils::IPos::ptr& pos) :
  type_ (type),
  pos_ (pos)
{
...
{
  U3_CHECK_COPY_EVENT (MouseButtonUpEvent);
  super::copy_int (src);
  type_ = dsrc->type_;
  pos_  = dsrc->pos_;
}
...
void
MouseButtonUpEvent::serialize (Archive& ar, const std::uint32_t /* file_version */)
{
