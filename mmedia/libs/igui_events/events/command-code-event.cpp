...
{
CommandCodeEvent::CommandCodeEvent (const Acessor& ph, const std::string& code) :
  code_ (code)
{
...
{
  U3_CHECK_COPY_EVENT (CommandCodeEvent);
  super::copy_int (src);
  code_ = dsrc->code_;
}
...
void
CommandCodeEvent::serialize (Archive& ar, const std::uint32_t /* file_version */)
{
