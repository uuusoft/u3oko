/**
\file       freq_dct_one_b8x8_forward_mmx.cpp
\date       01.11.2016
...
//
/*
static const std::int16_t tab_inv_01234567[] = { // inverse_dct coeff table
...
#  else
  static long long     xt70[2];   // xt7xt6xt5xt4, xt3xt2xt1xt0
  static int           a0, a1, a2, a3, b0, b1, b2, b3;
  static std::int16_t *sptr, *optr, *tf;   // tf = table_ptr
  static std::int16_t *xt = (short *) &xt70[0];
  static int           j;
  ...
  static std::int16_t t0, t1, t2, t3, t4, t5, t6, t7;
  static std::int16_t tp03, tm03, tp12, tm12, tp65, tm65;
  static std::int16_t tp465, tm465, tp765, tm765;
...
#  endif
  /*
      ...
      //#define X86_PMULHRW( X ) ( (std::int16_t) ( ( ( ( (int )X)>>15 )+1 ) >>1 ) ) // 3DNow-MMX
