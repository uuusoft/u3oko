/**
\file       scale_wdown_b2x2_generic.cpp
\date       01.11.2016
...
get_params (::libs::optim::io::MCallInfo& info, CallParams& params)
{
  params.reset ();
    ...
    params.stride_output_  = boost::any_cast<std::size_t*>( info.params_.evals_[0] );
    params.max_out_size_ = boost::any_cast<std::size_t*>( info.params_.evals_[1] );;
