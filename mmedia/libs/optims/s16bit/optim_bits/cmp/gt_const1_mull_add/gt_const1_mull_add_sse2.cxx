/**
\file       gt_const1_mull_add_sse2.cxx
...
#  else
  ...
  calc_dest_source_dims (
    info.dsts_[0].stride_, info.srcs_[0].stride_, info.dsts_[0].width_, info.dsts_[0].height_, 8, number_sub_pixel_x, number_sub_pixel_y, leak_stride_source, leak_stride_dest);
