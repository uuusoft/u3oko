...
check (const ::libs::optim::io::MCallInfo& info)
{
  ...
  info.dsts_[0].check ("dst 0 bits::cmp::gt_add");

  U3_CHECK (1 == info.srcs_.size (), "src not equal 1");

  info.srcs_[0].check ("src 0 bits::cmp::gt_add");
...
#include "gt_add_alu.cxx"
#include "gt_add_sse2.cxx"
#include "gt_add_avx1.cxx"
#include "gt_add_avx2.cxx"
