...
{
  U3_CHECK (2 == info.params_.evals_.size (), "evals not equal 2");
...
/// первый коэффициент положительный это база, все полседующий отрицательные - это смещения
