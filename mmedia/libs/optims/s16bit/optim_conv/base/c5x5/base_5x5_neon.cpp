...
{
  move_alg< TModNeonCalcObj, cores::values_core_type, TPostProcessor, consts::size_core > (info);
}
...
{
  move_alg< TNeonCalcObj, cores::values_core_type, TPostProcessor, consts::size_core > (info);
}
}   // namespace libs::optim::s16bit::conv::base::c5x5
