...
class MouseButtonUpEvent : public BaseGUIEvent
{
  ...
  public:
  //  ext types
  U3_ADD_POINTERS_TO_SELF (MouseButtonUpEvent)
  U3_ADD_MAKE_SHARED_THIS (MouseButtonUpEvent)
  U3_ADD_DELETE_MOVE_COPY (MouseButtonUpEvent)
  ...
  {
    static constexpr const char* chret = "libs/events_gui/events/props/mouse-button-up-event";
...
BOOST_CLASS_EXPORT_KEY (::libs::events_gui::events::MouseButtonUpEvent);
