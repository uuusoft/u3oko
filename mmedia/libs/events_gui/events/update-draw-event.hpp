...
class UpdateDrawEvent : public BaseGUIEvent
{
  ...
  public:
  //  ext types
  U3_ADD_POINTERS_TO_SELF (UpdateDrawEvent)
  U3_ADD_MAKE_SHARED_THIS (UpdateDrawEvent)
  U3_ADD_DELETE_MOVE_COPY (UpdateDrawEvent)
  ...
  {
    static constexpr const char*            chret = "libs/events_gui/events/props/update-draw-event";
...
BOOST_CLASS_EXPORT_KEY (::libs::events_gui::events::UpdateDrawEvent);
