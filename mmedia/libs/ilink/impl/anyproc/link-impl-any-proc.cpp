...
{
  volatile ::libs::helpers::hboost::NameRemover remover_msgs (info_.id_arg2val_[::libs::link::consts::text::id_name_queue2dest]);
  volatile ::libs::helpers::hboost::NameRemover remover_send_msgs (info_.id_arg2val_[::libs::link::consts::text::id_name_queue2dest] + ".send");
  volatile ::libs::helpers::hboost::NameRemover remover_recv_msgs (info_.id_arg2val_[::libs::link::consts::text::id_name_queue2dest] + ".recv");
  volatile ::libs::helpers::hboost::NameRemover remover_shared_mem (info_.id_arg2val_[::libs::link::consts::text::id_name_shared_mem]);
  volatile ::libs::helpers::hboost::NameRemover remover_sync_init_event (info_.id_arg2val_[::libs::link::consts::text::id_sync_init_event]);
  volatile ::libs::helpers::hboost::NameRemover remover_sync_init_event_flag (info_.id_arg2val_[::libs::link::consts::text::id_sync_init_event] + ".flag");
  volatile ::libs::helpers::hboost::NameRemover remover_sync_init_event_cond (info_.id_arg2val_[::libs::link::consts::text::id_sync_init_event] + ".cond");
}
}   // namespace libs::ilink::impl::anyproc
