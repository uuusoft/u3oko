...
class LinkCreatorImplAnyProc : public ::libs::link::ILinkCreator
{
  ...
  private:
  //  internal typess
  using helper2ptr_type  = std::unordered_map< ::libs::link::details::ModuleLinks, ::libs::link::ILink::ptr >;
  using type_helper2info = std::unordered_map< ::libs::link::details::ModuleLinks, ::libs::link::CreateInfo >;
