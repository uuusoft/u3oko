...
class ListDevicesDataEvent : public BaseDataEvent
{
  ...
  U3_ADD_POINTERS_TO_SELF (ListDevicesDataEvent)
  U3_ADD_MAKE_SHARED_THIS (ListDevicesDataEvent)
  U3_ADD_DELETE_MOVE_COPY (ListDevicesDataEvent)

  explicit ListDevicesDataEvent (
    const Acessor&            = Acessor (0),
    src_names_type    group   = src_names_type (),
    src_devinfos_type devices = src_devinfos_type ());
  ...
  {
    static constexpr const char*            chret = "libs/events_media/events/list-devices-data-event";
