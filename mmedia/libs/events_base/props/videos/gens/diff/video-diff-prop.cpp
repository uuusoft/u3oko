...
auto
VideoDiffProp::get_mid_int () const -> const ::libs::events::IEvent::hid_type&
{
  return VideoDiffProp::gen_get_mid ();
}


auto
VideoDiffProp::clone_int (const ::libs::events::Deeps& deep) const -> ::libs::events::IEvent::ptr
{
