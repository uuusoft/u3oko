...
auto
VideoCorrectProp::get_mid_int () const -> const ::libs::events::IEvent::hid_type&
{
  return VideoCorrectProp::gen_get_mid ();
}


auto
VideoCorrectProp::clone_int (const ::libs::events::Deeps& deep) const -> ::libs::events::IEvent::ptr
{
...
VideoCorrectProp::load_json_int (const ::boost::json::object& obj)
{
  ...
  hint_correct_impl_      = to_selector_impl_type (::libs::utility::json::get_uint32 (obj.at ("hint_correct_impl")));
}
...
{
  ::libs::utility::utils::check_bound< float > (saturation_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (bright_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (contrast_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (sharp_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (hue_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (gamma_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (white_balance_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (backlight_compensation_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (gain_.first, consts::min, consts::max);
  ::libs::utility::utils::check_bound< float > (exposure_.first, consts::min, consts::max);
}
}   // namespace libs::events_base::props::videos::generic::correct
