...
auto
VideoDetectProp::get_mid_int () const -> const ::libs::events::IEvent::hid_type&
{
  return VideoDetectProp::gen_get_mid ();
}


auto
VideoDetectProp::clone_int (const ::libs::events::Deeps& deep) const -> ::libs::events::IEvent::ptr
{
...
VideoDetectProp::load_json_int (const ::boost::json::object& obj)
{
  ...
  bound_                = ::libs::utility::json::get_int32 (obj.at ("bound"));
  size_core_morph_op_   = ::libs::utility::json::get_int32 (obj.at ("size_core_morph_op"));
  id_morph_op_          = obj.at ("id_morph_op").as_string ();
  counter_morph_op_     = ::libs::utility::json::get_int32 (obj.at ("counter_morph_op"));
  min_size_spot_        = ::libs::utility::json::get_int32 (obj.at ("min_size_spot"));
  max_size_spot_        = ::libs::utility::json::get_int32 (obj.at ("max_size_spot"));
  bufs_                 = ::boost::json::value_to< ::libs::events::buf::EventBufs > (obj.at ("evbufs"));
  time_after_last_move_ = ::libs::utility::json::get_int32 (obj.at ("time_after_last_move"));
  lazy_optim_           = obj.at ("lazy_optim").as_bool ();
  time_id_              = ::libs::utility::json::get_int32 (obj.at ("time_id"));
  zone_id_              = ::libs::utility::json::get_int32 (obj.at ("zone_id"));
...
{
  ::libs::utility::utils::check_bound< std::int32_t > (bound_, 1, 255);
  ::libs::utility::utils::check_bound< std::int32_t > (size_core_morph_op_, 3, 11);
  ::libs::utility::utils::check_bound< std::int32_t > (counter_morph_op_, 0, 5);
  ::libs::utility::utils::check_bound< std::int32_t > (min_size_spot_, 0, 100);
  ::libs::utility::utils::check_bound< std::int32_t > (max_size_spot_, 0, 1000);
