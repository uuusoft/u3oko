...
auto
tag_invoke (::boost::json::value_to_tag< BuffVideoConvolutionProp >, const ::boost::json::value& jvs) -> BuffVideoConvolutionProp
{
  const auto&                  pobj = jvs.at ("parent").as_object ();
  BuffVideoConvolutionProp     ret (::libs::events::buf::tag_invoke (::boost::json::value_to_tag< ::libs::events::buf::EventBufs > (), pobj));
  const ::boost::json::object& obj = jvs.as_object ();

  ret.convolution_type_ = ::boost::json::value_to< Convs > (obj.at ("convolution_type"));
  ret.core_size_        = ::libs::utility::json::get_int32 (obj.at ("core_size"));
  ret.core_vals_        = ::boost::json::value_to< std::vector< std::int16_t > > (obj.at ("core_vals"));
  ret.core_koeff_       = ::libs::utility::json::get_int32 (obj.at ("core_koeff"));
