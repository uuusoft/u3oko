...
{
EventBufsMotionEst::EventBufsMotionEst (
...
EventBufsMotionEst::EventBufsMotionEst (const ::libs::events::buf::EventBufs& buf) :
...
void
EventBufsMotionEst::correct_int ()
{
...
{
  arh& U3_BOOST_SERIALIZE_MAKE_NVP ("olibsoeventsobufoEventBufsMotionEst", super);
...
auto
tag_invoke (::boost::json::value_to_tag< EventBufsMotionEst >, const ::boost::json::value& jvs) -> EventBufsMotionEst
{
  const auto&                  pobj = jvs.at ("parent").as_object ();
  EventBufsMotionEst           ret (::libs::events::buf::tag_invoke (::boost::json::value_to_tag< ::libs::events::buf::EventBufs > (), pobj));
  const ::boost::json::object& obj = jvs.as_object ();

  ret.max_error_   = ::libs::utility::json::get_float (obj.at ("max_error"));
  ret.min_error_   = ::libs::utility::json::get_float (obj.at ("min_error"));
  ret.size_block_  = ::libs::utility::json::get_int32 (obj.at ("size_block"));
  ret.size_search_ = ::libs::utility::json::get_int32 (obj.at ("size_search"));
  ret.search_vecs_ = ::boost::json::value_to< EventBufsMotionEst::vectors_type > (obj.at ("search_vecs"));
  return ret;
}
}   // namespace libs::events_base::props::videos::generic::motion_est
