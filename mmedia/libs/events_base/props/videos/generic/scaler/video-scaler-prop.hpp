...
{
class VideoScalerProp final : virtual public events_base::Event
{
  ...
  public:
  //  ext types
  using bufs_type = std::vector< EventBufsVideoScaler >;

  U3_ADD_POINTERS_TO_SELF (VideoScalerProp)
  U3_ADD_MAKE_SHARED_THIS (VideoScalerProp)
  U3_ADD_DELETE_MOVE_COPY (VideoScalerProp)
  ...
  {
    static constexpr const char* chret = "libs/events_base/props/videos/generic/scaler/video-scaler-prop";
