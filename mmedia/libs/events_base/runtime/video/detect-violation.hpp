...
class DetectViolation : public RuntimeEvent
{
  ...
  public:
  //  ext types
  U3_ADD_POINTERS_TO_SELF (DetectViolation)
  U3_ADD_MAKE_SHARED_THIS (DetectViolation)
  U3_ADD_DELETE_MOVE_COPY (DetectViolation)
  ...
  {
    static constexpr const char*            chret = "libs/events_base/runtime/video/detect-violation";
    static constexpr const IEvent::hid_type ret { chret };
    return ret;
  }

  auto sync_event_props (const DetectViolations&) -> void;
  auto set_state (const DetectViolations& state) -> void;
  auto get_state () const -> const DetectViolations&;
