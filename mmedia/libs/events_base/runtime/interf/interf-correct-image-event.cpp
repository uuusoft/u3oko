...
{
InterfCorrectImageEvent::InterfCorrectImageEvent (const Acessor& pha, impl_ptr_type impl) :
  impl_ (std::move (impl))
{
}
...
auto
InterfCorrectImageEvent::get_mid_int () const -> const ::libs::events::IEvent::hid_type&
{
  return InterfCorrectImageEvent::gen_get_mid ();
}


auto
InterfCorrectImageEvent::get_interface () -> InterfCorrectImageEvent::impl_ptr_type
{
...
auto
InterfCorrectImageEvent::clone_int (const ::libs::events::Deeps& deep) const -> ::libs::events::IEvent::ptr
{
...
#ifdef U3_DISABLE_AS_0_FOR_CLANG_TIDY
BOOST_CLASS_EXPORT_IMPLEMENT (::libs::events_base::runtime::interf::InterfCorrectImageEvent);
U3_BOOST_ADD_SERIALIZE_ARCH (::libs::events_base::runtime::interf::InterfCorrectImageEvent);
#endif
