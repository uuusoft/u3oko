...
auto
GetRuntimeInfo::get_mid_int () const -> const ::libs::events::IEvent::hid_type&
{
  return GetRuntimeInfo::gen_get_mid ();
}


auto
GetRuntimeInfo::clone_int (const ::libs::events::Deeps& deep) const -> ::libs::events::IEvent::ptr
{
...
BOOST_CLASS_EXPORT_IMPLEMENT (::libs::events_storage::events::GetRuntimeInfo);
U3_BOOST_ADD_SERIALIZE_ARCH (::libs::events_storage::events::GetRuntimeInfo);
