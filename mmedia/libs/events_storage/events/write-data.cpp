...
auto
WriteData::get_mid_int () const -> const ::libs::events::IEvent::hid_type&
{
  return WriteData::gen_get_mid ();
}
...
auto
WriteData::get_stream_id () const -> const stream_id_type&
{
  return stream_id_;
}
...
auto
WriteData::get_msg () const -> ::libs::events::IEvent::ptr
{
  return buf_;
}
...
auto
WriteData::clone_int (const ::libs::events::Deeps& deep) const -> ::libs::events::IEvent::ptr
{
...
BOOST_CLASS_EXPORT_IMPLEMENT (::libs::events_storage::events::WriteData);
U3_BOOST_ADD_SERIALIZE_ARCH (::libs::events_storage::events::WriteData);
