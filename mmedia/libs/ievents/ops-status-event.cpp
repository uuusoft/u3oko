...
OpsStatusEvent::clone_int (const ::libs::events::Deeps& deep) const
{
...
BOOST_CLASS_EXPORT_IMPLEMENT (::libs::ievents::OpsStatusEvent);
U3_BOOST_SERIALIZE_ALL_ARCHIVES (::libs::ievents::OpsStatusEvent);
