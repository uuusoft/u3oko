...
void          tag_invoke (::boost::json::value_from_tag, ::boost::json::value& jv, const SyncObjsGroup& src);
SyncObjsGroup tag_invoke (::boost::json::value_to_tag< SyncObjsGroup >, const ::boost::json::value& jv);
}   // namespace libs::ievents::runtime::control
