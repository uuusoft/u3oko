...
{
BaseInterfEvent::BaseInterfEvent (const Acessor& ph) :
  active_ (false)
{
...
{
  U3_CHECK_COPY_EVENT (BaseInterfEvent);
  super::copy_int (src);
...
void
BaseInterfEvent::serialize (Archive& ar, const std::uint32_t /* file_version */)
{
