...
namespace libs::ievents::props::videos::generics::matrix
{
  ...
  ::libs::events::IEvent::ptr CVideoMatrixProp::clone_int( const ::libs::events::Deeps& deep ) const
  {
  ...
  void CVideoMatrixProp::serialize (Archive & ar, const std::uint32_t /* file_version */)
  {
