...
{
class VideoDriverProp final : public ievents::Event
{
  ...
  gen_get_mid ()
  {
    static const IEvent::hid_type ret = "libs/ievents/props/videos/generic/driver/video-driver-prop";
    return ret;
  }
  ...
  std::int32_t                                   device_indx_;     //< Индекс устройства в каталоге dshow. DEPRECATED
