...
class VideoDriverCaptureProp final : virtual public ievents::Event
{
  ...
  {
    static constexpr const char* chret = "libs/ievents/props/videos/generic/driver/video-driver-capture-prop";
