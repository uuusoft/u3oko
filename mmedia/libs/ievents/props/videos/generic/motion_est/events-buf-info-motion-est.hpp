...
void                   tag_invoke (::boost::json::value_from_tag, ::boost::json::value& jv, const EventBufsInfoMotionEst& src);
EventBufsInfoMotionEst tag_invoke (::boost::json::value_to_tag< EventBufsInfoMotionEst >, const ::boost::json::value& jv);
}   // namespace libs::ievents::props::videos::generic::motion_est
