...
namespace libs::ievents::props::videos::generic::codec::syn
{
...
class VideoCodecProp : virtual public ievents::Event
{
  ...
  {
    static constexpr const char* chret = "libs/ievents/props/videos/generic/codec/video-codec-prop";
  ...
  syn::EventBufsInfo bufs_ { ::utils::dbufs::video::consts::offs::lit, ::utils::dbufs::video::consts::offs::http };   //< Буфер источника/назначения. Опционален
  ...
  SelectorImpls      hint_codec_impl_      = ::libs::ievents::SelectorImpls::automatic;                               //< Опциональный идентификатор реализации. Например "auto", "hard", "soft", etc
