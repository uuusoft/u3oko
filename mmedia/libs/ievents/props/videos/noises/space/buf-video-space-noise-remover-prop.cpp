...
BuffVideoSpaceNoiseRemoverProp
tag_invoke (::boost::json::value_to_tag< BuffVideoSpaceNoiseRemoverProp >, const ::boost::json::value& jvs)
{
...
BOOST_CLASS_EXPORT_IMPLEMENT (::libs::ievents::props::videos::noises::space::BuffVideoSpaceNoiseRemoverProp);
U3_BOOST_SERIALIZE_ALL_ARCHIVES (::libs::ievents::props::videos::noises::space::BuffVideoSpaceNoiseRemoverProp);
