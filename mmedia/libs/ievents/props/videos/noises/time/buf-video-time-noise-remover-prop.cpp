...
tag_invoke (::boost::json::value_from_tag tag, ::boost::json::value& jvs, const BuffVideoTimeNoiseRemoverProp& src)
{
  ...
  ::libs::events::buf::tag_invoke (tag, pjv, ::libs::helpers::casts::static_cast_helper< const ::libs::events::buf::EventBufsInfo& > (src));
...
BuffVideoTimeNoiseRemoverProp
tag_invoke (::boost::json::value_to_tag< BuffVideoTimeNoiseRemoverProp >, const ::boost::json::value& jvs)
{
  const auto&                   pobj = jvs.at ("parent").as_object ();
  BuffVideoTimeNoiseRemoverProp ret (::libs::events::buf::tag_invoke (::boost::json::value_to_tag< ::libs::events::buf::EventBufsInfo > (), pobj));
...
BOOST_CLASS_EXPORT_IMPLEMENT (::libs::ievents::props::videos::noises::time::BuffVideoTimeNoiseRemoverProp);
U3_BOOST_SERIALIZE_ALL_ARCHIVES (::libs::ievents::props::videos::noises::time::BuffVideoTimeNoiseRemoverProp);
