...
class VideoTimeNoiseRemoverProp final : virtual public ievents::Event
{
  ...
  {
    static constexpr const char* chret = "libs/ievents/props/videos/noises/time/video-time-noise-remover-prop";
