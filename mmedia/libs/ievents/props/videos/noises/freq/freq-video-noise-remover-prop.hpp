...
{
class FreqVideoNoiseRemoverProp final : virtual public ievents::Event
{
  ...
  {
    static constexpr const char* chret = "libs/ievents/props/videos/noises/freq/freq-video-noise-remover-prop";
