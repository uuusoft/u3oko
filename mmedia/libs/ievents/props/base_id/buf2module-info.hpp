...
void            tag_invoke (::boost::json::value_from_tag, ::boost::json::value& jv, const Buff2ModuleInfo& src);
Buff2ModuleInfo tag_invoke (::boost::json::value_to_tag< Buff2ModuleInfo >, const ::boost::json::value& jv);
}   // namespace libs::ievents::props::base_id
