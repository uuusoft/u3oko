#pragma once
/**
\file       libs-icore-includes_int.hpp
\date       01.05.2017
...
#include "mmedia/libs/helpers/files/libs-helpers-files-includes.hpp"

#include "mmedia/libs/proxy/proxy/ioptim-proxy.hpp"
#include "mmedia/libs/proxy/proxy/ievents-proxy.hpp"

#include "libs-icore-includes.hpp"

#undef U3_FILE_LOG_TAG
#define U3_FILE_LOG_TAG "u3icorelib            "
