...
auto
InfoLogEvent::get_mid_int () const -> const ::libs::events::IEvent::hid_type&
{
  return InfoLogEvent::gen_get_mid ();
}


auto
InfoLogEvent::get_appl_info () const -> const AppllPartLogInfo&
{
  return appl_;
}
...
auto
InfoLogEvent::text (const LogTexts& type) const -> std::string
{
  switch (type)
  {
...
auto
InfoLogEvent::clone_int (const ::libs::events::Deeps& deep) const -> ::libs::events::IEvent::ptr
{
