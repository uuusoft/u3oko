...
#  define U3_CAST_INT32_FORCE(u3def_val) ::libs::utility::casts::static_cast_helper< std::int32_t > (u3def_val)
#endif
...
#  define U3_CAST_UINT32_FORCE(u3def_val) ::libs::utility::casts::static_cast_helper< std::uint32_t > (u3def_val)
#endif
...
#  define U3_CAST_SIZE_T_FORCE(u3def_val) ::libs::utility::casts::static_cast_helper< std::size_t > (u3def_val)
#endif
...
#  define U3_CAST_INT64_FORCE(u3def_val) ::libs::utility::casts::static_cast_helper< std::int64_t > (u3def_val)
#endif
...
#  define U3_CAST_UINT64_FORCE(u3def_val) ::libs::utility::casts::static_cast_helper< std::uint64_t > (u3def_val)
#endif
