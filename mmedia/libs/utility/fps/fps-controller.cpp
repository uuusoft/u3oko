...
auto
FpsController::get_leak () const -> float
{
  return leak_time_;
}
...
auto
FpsController::get_fps () const -> float
{
  return fps_;
}
...
auto
FpsController::get_time_after_last () -> FpsController::duration_type
{
