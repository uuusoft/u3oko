...
{
  public:
  U3_ADD_DELETE_MOVE_COPY (HandlerGdiObj)
  ...
  ~HandlerGdiObj ()
  {
    libs::utility::platforms::win32::safe_delete_gdi_object< TTGDIObj > (obj_);
  }
...
{
  public:
  U3_ADD_DELETE_MOVE_COPY (HandlerWindowDC)
...
{
  public:
  U3_ADD_DELETE_MOVE_COPY (HandlerCompatibleDC)
