  ...
  VIDEOINFOHEADER*                            vihead)
{
  ...
  vihead->bmiHeader.biCompression   = 0;   // libs::utility::uids::helpers::idval2fourcc (format);
...
{
  static const boost::unordered_flat_map< utils::cuuid, const unsigned long > guid2dword = {
  ...
  {
    U3_XLOG_WARN ("guid2dword_compression: guid not found, default value for " + uids::helpers::get_readable_name (guid) + " guid=" + ::libs::utility::utils::to_string (guid));
...
dword_compression2guid (const unsigned long val, const BITMAPINFOHEADER* bmp)
{
  ...
  static const boost::unordered_flat_map< unsigned long, std::function< utils::cuuid (const BITMAPINFOHEADER*) > > dword2guid = {
