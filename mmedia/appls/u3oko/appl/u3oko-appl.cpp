...
U3OkoAppl::init_links_int (const syn::InitApplication& info)
{
  ...
  links_.get (libs::properties::vers::links::mids::appl2log)->send_msg (appl_event_props_.module_log_, ::libs::link::details::CallSyncs::async, ::libs::link::details::Calls::set);
  //  Устанавливаем свойства хранилища.
  links_.get (libs::properties::vers::links::mids::appl2storage)->send_msg (appl_event_props_.storage_module_, ::libs::link::details::CallSyncs::async, ::libs::link::details::Calls::set);
}
...
U3OkoAppl::update_catch_funcs_int ()
{
  ...
  catch_funcs_[syn::CommandCodeEvent::gen_get_mid ()] =
    [this] (::libs::events::IEvent::ptr& msg, bool forward, const syn::StateProcessEventExt& process_state) {
      if (forward)
      {
        auto _rmsg = ::libs::iproperties::helpers::cast_event< syn::CommandCodeEvent > (msg);
        U3_LOG_APPL_DEV ("catch ::libs::igui_events::events::CommandCodeEvent, " + _rmsg->get_code ());
        stop_module_ = true;
...
U3OkoAppl::get_recv_link ()
{
  return recv_links_type {
    ...
    links_.get (libs::properties::vers::links::mids::appl2gui),
#endif
    links_.get (libs::properties::vers::links::mids::appl2mdata),
    links_.get (libs::properties::vers::links::mids::appl2http),
    links_.get (libs::properties::vers::links::mids::appl2log),
    links_.get (libs::properties::vers::links::mids::appl2events),
    links_.get (libs::properties::vers::links::mids::appl2storage)
  };
}
}   // namespace appls::u3oko::appl
