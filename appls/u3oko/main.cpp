...
\project    u3oko
\brief      Основной файл центрального модуля системы видеонаблюдения.
*/
#include "mmedia/defines/defines.hpp"
#include "mmedia/defines/includes.hpp"
#include "includes_int.hpp"
//#include "appl/benchmark-state.hpp"
...
create_impl ()
{
  ...
  ++counter_refs_;
  XULOG_INFO ("::libs::link::appl::IApplication, " << to_str (counter_refs_) << ", " << to_str (g_appl));
  return g_appl;
}
