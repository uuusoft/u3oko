...
class UpdateDrawEvent : public BaseGUIEvent
{
  ...
  public:
  //  ext types
  UUU_THIS_TYPE_HAS_POINTERS_TO_SELF (UpdateDrawEvent);
  UUU_ADD_MAKE_SHARED_FUNCT2THIS_TYPE (UpdateDrawEvent);
  UUU_DISABLE_ACOPY_TYPE (UpdateDrawEvent);
  ...
  {
    static const std::string _ret = "libs/igui_events/events/props/update-draw-event";
    return _ret;
  }
