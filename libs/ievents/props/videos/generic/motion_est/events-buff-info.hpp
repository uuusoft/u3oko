...
struct EventBuffsInfo : public ::libs::events::buff::EventBuffsInfo
{
  ...
  explicit EventBuffsInfo (const Acessor& = Acessor (0)) :
...
BOOST_CLASS_EXPORT_KEY (::libs::ievents::props::videos::generics::motion_est::EventBuffsInfo);
