...
BOOST_CLASS_EXPORT_IMPLEMENT (::libs::ievents::props::videos::generics::motion_est::EventBuffsInfo);
SERIALIZE_TYPE_TO_ARCHIVES (::libs::ievents::props::videos::generics::motion_est::EventBuffsInfo);
