...
\project    uuu_events
*/
namespace libs { namespace events { namespace buff { namespace consts {

const std::string node_name = "buff";      //< Идентификатор буфера в xml узле.

}}}}      // namespace libs::events::buff::consts
...
/**
  ...
  */
struct BuffEventInfo
{
  public:
  BuffEventInfo (const off_buff_type& _src = utils::dbuffs::video::consts::offs::invalid, const off_buff_type& _dst = utils::dbuffs::video::consts::offs::invalid);
...
BOOST_CLASS_EXPORT_KEY (::libs::events::buff::BuffEventInfo);
