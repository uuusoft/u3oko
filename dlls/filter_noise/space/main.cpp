...
\brief      Основной файл модуля фильтрации изображения в пространственной области.
*/
...
#endif
  ::libs::icore::impl::var1::obj::dll::IFilter::raw_ptr _ret (new ::dlls::filter_noise::space::Filter);
  return _ret;
}
